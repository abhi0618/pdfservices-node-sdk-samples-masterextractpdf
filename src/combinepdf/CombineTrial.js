...
try {
    ...
    for (i=0,i==22,i++)[
        const combineSource[i] = PDFServicesSdk.FileRef.createFromLocalFile('resources/MultipleFilesOperationTesting/testfile[i].pdf');

   combineFilesOperation.addInput(combineSource[i]);
    ]
